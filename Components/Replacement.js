...
const Replacement = () => {
  return (
    <div className="replacement">
      <div className="replacement1">
        <div>
          <p style={{ fontSize: "60px", color: "#175C62" }}>
            Knee Replacement <span style={{ color: "#01CAB8" }}>Surgery</span>{" "}
            Procedure
          </p>
        </div>
        <div>
          <p style={{ fontSize: "22px", color: "#175C62" }}>
            Knee joint replacement is a surgery to replace a knee joint with a
            man-made artificial joint.
          </p>
        </div>
        {arr?.map((item, index) => (
          <div>
            <div className="cards3" key={index}>
              <div>
                <img
                  ...
                  alt=""
                />
                <p style={{ color: "#175C62", fontWeight: "bold" }}>
                  {item.title}
                </p>
              </div>
              <div>
                <p style={{ color: "#175C62" }}>{item.des}</p>
              </div>
            </div>
            <hr />
          </div>
      ...
      <div className="replacement2">
        <img
          src="/images/inner_image_home.gif"
          alt=""
